...
describe("Community Routes (Integration)", () => {
  ...
  describe("POST /api/communities", () => {
    it("creates a community successfully", async () => {
      ...
      const res = await makeRequest("post", "/api/communities", {
        name,
    ...
    it("fails with duplicate name", async () => {
      ...
      await makeRequest("post", "/api/communities", {
        name,
        description: "First",
      });
  ...
  describe("GET /api/communities/:id", () => {
    it("returns community by id", async () => {
      const { body: created } = await makeRequest("post", "/api/communities", {
        name: uniqueName(),
        description: "Desc",
      });
  ...
  describe("PUT /api/communities/:id", () => {
    it("updates community successfully", async () => {
      ...
      const res = await makeRequest("patch", `/api/communities/${created.id}`, {
        name: newName,
        description: "Updated",
      });
