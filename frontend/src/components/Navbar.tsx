...
const Navbar = () => {
  return (
    <>
      {/* Mobile Bottom Bar */}
      <nav className="fixed bottom-0 left-0 w-full bg-white border-t flex justify-around p-2 md:hidden z-10 rounded-t-md shadow-md">
        {[
          { to: '/', label: 'Home', icon: (
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-4 0H7m-4 0" />
          )},
          { to: '/events', label: 'Events', icon: (
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
          )},
          { to: '/signups', label: 'Signups', icon: (
          ...
          { to: '/my-events', label: 'My Events', icon: (
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v13m0-13V6a2 2 0 110-4m0 4v-2a2 2 0 100 4m6 8.74l-6-4-6 4V21h12v-2.26z" />
          )},
