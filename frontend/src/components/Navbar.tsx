  ...
  return (
    <>
      ...
      <nav   className="
          ...
          flex justify-around py-4 md:hidden z-10 
        ...
        {[
          ...
          <Link
            key={to}
            to={to}
            className="flex flex-col items-center text-white/80 hover:text-white transition-all duration-200"
          >
      ...
      <nav className="
        hidden md:flex flex-col fixed left-4 top-24 bottom-6 w-64 
        bg-white/20 backdrop-blur-md border border-white/30 
        rounded-2xl shadow-lg p-5 gap-5 z-10 overflow-y-auto
      ">
        <h1 className="text-lg font-semibold text-white mb-3">Menu</h1>
        ...
        {[
          ...
          <Link
            ...
            className="
              ...
              p-2 rounded-md hover:bg-white/20 transition-all duration-200
            "
          >
            {label}
          </Link>
