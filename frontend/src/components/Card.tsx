...
const Card = ({
  ...
  return (
    <div className="bg-white/20 backdrop-blur-md rounded-2xl shadow-lg p-5 sm:p-6 flex flex-col md:flex-row md:items-center gap-3 sm:gap-4 border border-white/30">
      <div className="flex-1 flex flex-col gap-1.5 sm:gap-2">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between text-sm text-white/80 mt-1.5 sm:mt-2 gap-1 sm:gap-2">
          <span className="flex items-center gap-1 text-white/70">
            <Calendar size={15} /> {dayOfWeek}, {formattedDate} at{" "}
            {formattedTime}
          </span>
          <span className="flex items-center gap-1 text-white/70">
