...
const EventDetails = () => {
  ...
  if (!event) return <p className="p-4 text-center">Event not found</p>;
  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto mt-14 md:mt-24 md:ml-[18rem] relative">
      ...
      <div className="flex flex-col gap-4 bg-white/20 backdrop-blur-md rounded-xl shadow-md p-6 mt-4">
        ...
        {!userSignup ? (
          ...
          <div className="flex flex-col gap-4">
            ...
            <Button
              ...
              className="w-full sm:w-auto bg-gray-200 text-gray-800 hover:bg-gray-300 transition-colors duration-200"
            >
              Cancel Signup
            </Button>
          </div>
